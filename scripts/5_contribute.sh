...
# contribute
cleos transfer $CONTRIBUTOR createescrow "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CONTRIBUTOR
cleos transfer $CUSTODIAN_ACCOUNT createescrow "$AMOUNT" "$ORIGIN,$TOTAL_RAM,$TOTAL_ACCOUNTS" -p $CUSTODIAN_ACCOUNT
