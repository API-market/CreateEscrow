...
# This script calls the RECLAIM action of createescrow to get back the remaining airdrop token balance for a dapp
...
# reclaim dapp tokens
cleos push action createescrow reclaim '["'$DAPP_OWNER'","'$ORIGIN'","'$TOKEN'"]' -p $DAPP_OWNER